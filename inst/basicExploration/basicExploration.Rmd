...
```{r setup, warning=FALSE, bootstrap.show.message=FALSE, message = FALSE}
#### Libraries needed
...
## Make the table
if(outputIsHTML) {
    datatable(topArea, options = list(pagingType='full_numbers', pageLength=50, scrollX='100%'), rownames = FALSE) %>% formatRound(which(grepl('value$|area$|mean|log2FoldChange', colnames(topArea))), digits)
} else {
