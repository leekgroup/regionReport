...
print(xtable(qtable, digits = 4), type = 'html', include.rownames = FALSE)
```
...
## Make the table
kable(topArea, 'html', table.attr='id="regions_table"')
```
...
kable(permuteDetail, 'html', table.attr='id="permutation_table"')
```
