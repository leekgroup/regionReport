...
```{r runDerfinder, bootstrap.show.code=TRUE}
## Load derfinder
library('derfinder')

## The output will be saved in the 'derfinderReport-vignette' directory
dir.create('derfinderReport-vignette', showWarnings = FALSE, recursive = TRUE)
initialPath <- getwd()
setwd(file.path(initialPath, 'derfinderReport-vignette'))
...
## only one: chr21
mergeResults(chrnums='21', prefix='derfinderReport-vignette', 
...
```{r createReportFalse, eval=FALSE, bootstrap.show.code=TRUE}
## Generate the HTML report
report <- generateReport(prefix='derfinderReport-vignette', browse=FALSE,
...
## Load optionsStats
load(file.path('derfinderReport-vignette', 'chr21', 'optionsStats.Rdata'))
...
## Copy report output
file.copy(file.path('derfinderReport-vignette', 'basicExploration',
    'basicExploration.html'), '../inst/basicExploration/basicExploration.html')
...
You can view the pre-compiled report
[here](`r system.file(file.path("basicExploration", "basicExploration.html"),  package = "derfinderReport", mustWork = TRUE)`).
...
unlink("derfinderReport-vignette", recursive=TRUE)
```
